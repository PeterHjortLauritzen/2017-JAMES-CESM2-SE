...
\centering
 ...
 \caption{(a) The gnomonic equi-angular cubed-sphere grid that define the elements in CAM-SE. The red lines show the cubed-sphere panel edges. (b) A low resolution conformal mesh-refinement grid (elements) referred to as the CONUS-nest {\color{red}{[reference for CONUS?]}} used in CAM-SE.}
 \label{fig:grids}
\end{figure}
