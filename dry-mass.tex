...
\end{equation}
so that the moist pressure at half levels can be computed as the sum of the dry air mass and moisture mass hydrostatic pressures since there are no condensates present in the initial condition
\begin{equation}
