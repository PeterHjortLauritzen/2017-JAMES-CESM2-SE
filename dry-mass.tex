...
p(z)&=-g\int^{z'=\infty}_{z'=z}\rho\, dz',\\
 &=-g\int^{z'=\infty}_{z'=z}\rho_d \left( \sum_{\ell \in \mathcal{L}_{all}} m^{(\ell)} \right)\, dz',\\
...
\begin{equation}
{M}^{(\ell)}(z)=-\int^{z'=\infty}_{z'=z}\rho_d \, m^{(\ell)} \, dz'\label{eq:z'}.
\end{equation}
...
\begin{equation}
dp(z)=-g\, \rho \, dz = -g\rho_d \left( \sum_{\ell \in \mathcal{L}_{all}} m^{(\ell)}\right)\, dz = g\, dM^{(d)}(z)\left( \sum_{\ell \in \mathcal{L}_{all}} m^{(\ell)}\right).
\end{equation}
