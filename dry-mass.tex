...
\end{equation}
From \eqref{eq:dalton} it is clear that in the presence of condensate one can not equate $p^{(d)}(z)$ with ${M}^{(d)}(z)$, nor $p^{(wv)}(z)$ with ${M}^{(wv)}(z)$. The dry pressure and water vapor pressure are both affected by the weight of the condensates even though the condensates do not exert a pressure. Hence the dry pressure $p^{(d)}(z)$ at height $z$ is different from the pressure exerted by the weight of dry air above $M^{(d)}(z)$; and similar for moisture. The hydrostatic balance for dry air, written in terms of differentials, is given by
\begin{equation}
...
dp^{(d)}(z)\ne -\rho_d g dz.
\end{equation}
The dry pressure $p^{(d)}(z)$ at height $z$ will increase in the presence of condensates whereas the weight of dry air does not. The differential of the moist pressure can be written in terms of the pressure exerted by the weight of dry air mass (under the hydrostatic assumption) though:
\begin{equation}
...
\end{equation}
Then use the resulting change in dry mass surface pressures to determine the reference values for dry-mass thicknesses
\begin{equation}
